...
def custom_preprocessor(df):  # give the function a more informative name!!!
    ...
    Intended to be used under this particular circumstance, with {that other function} called before it,
    and potentially {yet another function} called after it, but optional.
